    ...
    return (
      <div>
        <h1 style={{ textAlign: "center" }}>
          Hello, World (Py-React-Docker-DigitalOcean POC)
        </h1>
        <div className="stringGenBox">
          <StringGeneratorForm
            onCreateString={this.handleGenerate}
      ...
      return (
        <div>
          <input
            ...
            className ="textInput"
          />
          <button onClick={this.handleCreate} className="btn">Give it now!</button>
        </div>
      );
      ...
      return (
        <div>
          <input
            ...
            className ="textInput"
          />
          <button onClick={this.handleReplace} className="btn">Replace</button>
          <button onClick={this.handleDelete} className="btn">Delete it</button>
        </div>
      );
    }
